...
namespace ManualCanDebug
{
    internal sealed class StudioProjectPropertiesWindow : Window
    {
        ...
        public StudioProjectPropertiesWindow(FctStudioProject project)
        {
            ...
            _projectName.Text = project.ProjectName; _product.Text = project.Product; _station.Text = Value(project, "StationName", "DEBUG"); _version.Text = Value(project, "SequenceVersion", "FCT-STUDIO-1"); _serialLength.Text = Value(project, "SerialNumberLen", "0"); _logPath.Text = Value(project, "LogFilePath", "Logs");
